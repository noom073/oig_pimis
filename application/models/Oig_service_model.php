...
class Oig_service_model extends CI_Model {
    ...
    {
        $this->oracle->select('pp.ID PID, pp."SET", pp.INS_DATE, pp.FINISH_DATE, pu.DEPARTMENT_NAME');
    ...
    {
        $this->oracle->select('SUBJECT_ID, SUBJECT_NAME, INSPECTION_ID, SUBJECT_PARENT_ID, SUBJECT_LEVEL');
    ...
    {
        $this->oracle->select('SUBJECT_ID, SUBJECT_NAME, INSPECTION_ID, SUBJECT_ORDER, SUBJECT_PARENT_ID, SUBJECT_LEVEL');
